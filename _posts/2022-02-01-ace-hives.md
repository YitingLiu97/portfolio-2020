...
## Cloud 
Free-standing interactive screens showcased the benefits of cloud technology. Content was divided into individual benefits that triggered related animations. The experience acts as a teaser for a workshop, creating a narrative arc and physical path to bring the guests to the demonstration space. 

Strategically placed sensors detect human figures and trigger the content. Guests see themselves represented as a point cloud that is used to visualize key drivers and statistics of Accenture's Cloud services.

![assets/ace-hives/cloud.jpg](assets/ace-hives/cloud.jpg)
![assets/ace-hives/cloud3.jpg](assets/ace-hives/cloud3.jpg)

## Human Potential 
Longstanding conceptions of work have been destabilized by the pandemic. Accenture is at the forefront of this vast digitalization of work that has quickly opened business leaders up to the necessary and exciting reality of onboarding, engaging and maintaining a diverse workforce, operating from home and from various locations around the world.
...
In idle state, a digital fog covers the interactive area, responding to users' position and motion. After the user dwells for a short time, the fog clears to activate brand messaging which displays around the users’ form and reveals their reflection.
...
## Life Science 
The experience is a vibrant, laboratory-inspired space, featuring a custom-designed video LED art installation. Revealed across a series of double-sided LED “test tubes”, the colors change with evolving LED animations, shifting from a collective cacophony of color to clear, bright, sharp images.
...
## New Consumer 
The hive invites the guest to interact with objects that represent trends in the retail industry to access content related to these trends. This concept helps illustrate how stores and retail spaces of the future will be able to engage their clients through advanced technology.

The hive features a museum-like custom built form, housing three screens and sixteen custom 3D-printed objects. When the user interacts with one of eight “Smart Objects”, RFID sensors placed in the object itself trigger object-specific content on screen. The other eight objects, called “Virtual Objects” trigger content as well, but add a 3D on-screen copy of the object that copies the real-life rotation of the physical object held.
...
Built to be completely self-standing, this scalable AR window technology allows the user to directly interact with the interactive maps, viewing animations that highlight the impact of 5G on these locations. Using a high-definition camera hidden behind the screen, this touch-screen interactive display intelligently highlights real-time data of NYC transportation system as well as hot spots that represent 5G innovations. 
